...
public class SettingsFragment extends Fragment {
    ...
    private void init(){
        ...
        mProfileImage = mView.findViewById(R.id.userSettingsProfileImageViewId);
        mNameText = mView.findViewById(R.id.userSettingsFragmentNameId);
        mNameEdit = mView.findViewById(R.id.userSettingsFragmentNameEditId);
        mEmailText = mView.findViewById(R.id.userSettingsFragmentEmailId);
        mChangePasswordText = mView.findViewById(R.id.userSettingsFragmentChangePasswordId);
        ...
        mNameEdit.setOnClickListener(v -> changeUserName());
    }
